    ...
    /******/ [
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        function getInitialCropFromCroppedAreaPixels(croppedAreaPixels, imageSize) {
          ...
          var crop = {
            x:
              ((imageSize.naturalWidth - croppedAreaPixels.width) / 2 - croppedAreaPixels.x) *
              cropZoom,
            y:
              ((imageSize.naturalHeight - croppedAreaPixels.height) / 2 - croppedAreaPixels.y) *
              cropZoom,
          }
          return {
            crop: crop,
...
*/
        ...
        var EmotionCacheContext = Object(external_React_['createContext'])(
        ...
        var core_browser_esm_render = function render(cache, props, theme, ref) {
          ...
          for (var key in props) {
            if (
              core_browser_esm_hasOwnProperty.call(props, key) &&
              key !== 'css' &&
              key !== typePropName &&
              (true || false)
            ) {
        ...
        var Emotion = core_browser_esm_withEmotionCache(function(props, cache, ref) {
          ...
          if (typeof props.css === 'function') {
            return Object(external_React_['createElement'])(ThemeContext.Consumer, null, function(
              theme
            ) {
        ...
        function styled_base_browser_esm_ownKeys(object, enumerableOnly) {
          var keys = Object.keys(object)
          if (Object.getOwnPropertySymbols) {
            var symbols = Object.getOwnPropertySymbols(object)
            if (enumerableOnly)
        ...
        function styled_base_browser_esm_objectSpread(target) {
          for (var i = 1; i < arguments.length; i++) {
            var source = arguments[i] != null ? arguments[i] : {}
            if (i % 2) {
              styled_base_browser_esm_ownKeys(source, true).forEach(function(key) {
                defineProperty_default()(target, key, source[key])
              })
            } else if (Object.getOwnPropertyDescriptors) {
              Object.defineProperties(target, Object.getOwnPropertyDescriptors(source))
            } else {
              styled_base_browser_esm_ownKeys(source).forEach(function(key) {
                Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key))
              })
            }
          }
          ...
          return function() {
            ...
            var Styled = core_browser_esm_withEmotionCache(function(props, context, ref) {
              return Object(
                ...
                var serialized = serialize_browser_esm_serializeStyles(
            ...
            Styled.withComponent = function(nextTag, nextOptions) {
              return createStyled(
                ...
                nextOptions !== undefined
                  ? styled_base_browser_esm_objectSpread({}, options || {}, {}, nextOptions)
                  : options
              ).apply(void 0, styles)
            }
        ...
        function styles_objectSpread(target) {
          for (var i = 1; i < arguments.length; i++) {
            var source = arguments[i] != null ? arguments[i] : {}
            if (i % 2) {
              styles_ownKeys(source, true).forEach(function(key) {
                styles_defineProperty(target, key, source[key])
              })
            } else if (Object.getOwnPropertyDescriptors) {
              Object.defineProperties(target, Object.getOwnPropertyDescriptors(source))
            } else {
              styles_ownKeys(source).forEach(function(key) {
                Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key))
              })
            }
          }
        ...
        var Img = styled_browser_esm('img')(
          {
            maxWidth: '100%',
            maxHeight: '100%',
            margin: 'auto',
          ...
          function(_ref2) {
            ...
            return styles_objectSpread({}, imageStyle)
          }
        )
          ...
          (function(_React$Component) {
            ...
            function Cropper() {
              ...
              _this.setInitialCrop = function() {
                ...
                var _getInitialCropFromCr = getInitialCropFromCroppedAreaPixels(
              ...
              _this.emitCropData = function() {
                ...
                var _computeCroppedArea = computeCroppedArea(
                    restrictedPosition,
                    _this.imageSize,
                    _this.state.cropSize,
                    _this.getAspect(),
              ...
              },
              {
                ...
                value: function render() {
                  ...
                  return external_React_default.a.createElement(
                    ...
                    this.state.cropSize &&
                      external_React_default.a.createElement(CropArea, {
                        cropShape: cropShape,
                        showGrid: showGrid,
                        style: {
